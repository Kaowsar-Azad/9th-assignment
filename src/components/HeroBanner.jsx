...
const HeroBanner = () => {
  return (
    <section className="relative overflow-hidden bg-gradient-to-b from-emerald-50/70 via-white to-transparent pt-12 md:pt-20 px-4">
      <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
        {/* Hero Left Content */}
        <div className="space-y-6 text-center lg:text-left">
          <div className="inline-flex items-center gap-1.5 bg-emerald-100 text-emerald-800 px-3.5 py-1.5 rounded-full text-xs font-bold shadow-sm uppercase tracking-wider animate-pulse">
            <Sparkles size={14} />
            Re-home & Save a Life Today
          </div>
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-extrabold text-slate-800 tracking-tight leading-none">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start pt-2">
            <Link
              href="/pets"
              className="btn btn-primary text-white px-8 h-12 rounded-xl font-bold flex items-center justify-center gap-2 shadow-lg shadow-emerald-500/20 hover:shadow-emerald-500/40"
            >
            ...
            <a
              href="#process"
              className="btn btn-outline border-slate-200 hover:bg-slate-50 hover:text-slate-800 text-slate-600 px-8 h-12 rounded-xl font-bold"
            >
              How It Works
            </a>
          </div>
          ...
          <div className="grid grid-cols-3 gap-4 pt-6 max-w-sm mx-auto lg:mx-0">
            <div className="text-center lg:text-left">
              ...
              <p className="text-xs text-slate-400 font-bold uppercase">Pets Saved</p>
            </div>
            <div className="text-center lg:text-left border-x border-slate-100 px-4">
              <p className="text-2xl font-black text-slate-800">50+</p>
              <p className="text-xs text-slate-400 font-bold uppercase">Partner Shelters</p>
            </div>
            <div className="text-center lg:text-left">
              <p className="text-2xl font-black text-slate-800">99%</p>
              <p className="text-xs text-slate-400 font-bold uppercase">Happy Matches</p>
            </div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-2 gap-4 relative">
          ...
          <div className="space-y-4">
            <div className="h-64 rounded-3xl overflow-hidden shadow-md transform hover:scale-[1.02] transition-transform duration-300">
            ...
            <div className="h-48 rounded-3xl overflow-hidden shadow-md transform hover:scale-[1.02] transition-transform duration-300">
