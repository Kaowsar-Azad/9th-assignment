    ...
    <section className="bg-[#f3f4f6] py-12 px-6">
      <div className="max-w-7xl mx-auto">
        <motion.div 
          ...
          className="bg-[#f8fafc] rounded-[2rem] border border-gray-100 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 py-16 shadow-sm"
        >
          {stats.map((stat, index) => (
            ...
            >
              ...
              <p className="text-[10px] md:text-[12px] font-bold text-[#1e293b] tracking-widest uppercase opacity-80 text-center">
                {stat.label}
              </p>
            </div>
          ))}
