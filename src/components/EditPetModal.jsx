...
export default function EditPetModal({ pet, onClose, onUpdated }) {
    ...
    const inputClass = "w-full h-12 px-4 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-700 hover:border-violet-400 focus:border-violet-500 rounded-xl font-medium text-slate-800 dark:text-slate-200 outline-none transition-all text-sm";
